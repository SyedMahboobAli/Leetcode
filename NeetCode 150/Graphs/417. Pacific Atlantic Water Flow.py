    ...
    def pacificAtlantic(self, heights: List[List[int]]) -> List[List[int]]:
        ...
        def dfs(r,c,visited):
            ...
            for dr,dc in ((0,1),(0,-1),(1,0),(-1,0)):
                nr,nc = r+dr, c+dc
                #This condition can be checked only in the loop and not in dfs due to heights check. it needs two cells:nr,nc and r,c. If we want to check this is dfs, we should send one more parameter
